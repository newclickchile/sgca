...
const ResidentLeft = ({ residentData }: { residentData: IResident }) => {
  return (
    <Card>
      <CardContent className='flex flex-col pbs-12 gap-6'>
        ...
        <div className='flex flex-col gap-4'>
          ...
          <div className='flex flex-col gap-2'>
            ...
            <InfoText label='Fecha Nacimiento' value={formatDate(residentData.fechaNacimiento)} />
            ...
            <InfoText label='Fecha ingreso' value={formatDate(residentData.fechaIngreso)} />
            <InfoText label='Fecha egreso' value={formatDate(residentData.fechaIngreso)} />
          </div>
        </div>
      </CardContent>
    </Card>
